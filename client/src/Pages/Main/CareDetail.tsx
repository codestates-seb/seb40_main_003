...
import { ProfileCard, ProfilePlantCard, CardWrapper, SigTag, ViewCounter, TagWrapper, SigButton } from "../../Components/GlobalComponents";
        ...
        <MainContentContainer>
            <MainCenterWrapper>
                <section>
                    ...
                    <CardWrapper><h1 className="h4 bold">돌봄 리뷰</h1></CardWrapper>
                </section>
        </MainCenterWrapper>
    <MainRightWrapper>
